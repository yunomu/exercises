...
isc.TMenu.ICON_FIELD = isc.clone(isc.TMenu.ICON_FIELD);
isc.addProperties(isc.TMenu.ICON_FIELD, {
    baseStyle: "tMenuIconField"
});
isc.TMenu.TITLE_FIELD = isc.clone(isc.TMenu.TITLE_FIELD);
isc.addProperties(isc.TMenu.TITLE_FIELD, {
